...
//    lcd.clear();
//    lcd.print(" KB1 buttonOK");
//  }
//   if (PULSADOR_2.wasPressed()) {
//    lcd.clear();
//    lcd.print("KB2 buttonC");
//    Serial.println(F("KB2 buttonC"));
//  
//  }
//   if (PULSADOR_3.wasPressed()) {
//    lcd.clear();
//    lcd.print("KB3 buttonIz");
//    Serial.println(F("KB3 buttonIz"));
//
//  }
//
//    if (PULSADOR_4.wasPressed()) {
//    lcd.clear();
//    lcd.print("KB4 buttonDe");
//    Serial.println(F("KB4 buttonDe"));
//   
//  }
}
